...
- `databricks/databricks-dolly-15k`: a dataset of 15 instructions, available on the HF datasets hub. To use this dataset, specify the following parameter in the training command: `--data_path "databricks/databricks-dolly-15k"`
